...
$mois = GETPOST("mois");
$annee = GETPOST("annee");
$fk_user = GETPOST("fk_user", "09");
$fk_salarie = GETPOST("fk_salarie", "09");
...
$obj_salarie = $db->fetch_object($res);
  ...
  global $fk_salarie, $fk_user, $y, $mois, $annee, $id_accord_etab;
}
...
if($action == "no_save"){
  ...
  $pdf->SetDrawColor(200, 200, 200);
    ...
    $tab_info_ind = salarie_indemnite($db, $obj_salarie->rowid, 0, $id_convention, $id_societe, $id_accord_etab);
              ...
              $anciennete_tab = prime_anciennete($db, $obj_salarie->rowid, $id_convention);
    ...
    $pdf->SetLeftMargin(103);
      ...
      $pdf->SetLeftMargin(83);
      $pdf->Cell(20,4, utf8_decode(apres_virgule($db, $id_societe, $salaire_base, 2)),0,0,'R');
      ...
      $tab_info_pr = salarie_prime($db, $obj_salarie->rowid, $salaire_base, $id_convention, $id_societe, $id_accord_etab);
                  ...
                  $pr = $db->fetch_object($prime_res);	
                    ...
                    $pdf->SetLeftMargin(103);
                    $pdf->Cell(30,4, utf8_decode(apres_virgule($db, $id_societe, $value, 2)),0,0,'R');				
                  ...
                  $val = $value;
                    ...
                    $pdf->SetLeftMargin(83);
                    $pdf->Cell(20,4, utf8_decode(apres_virgule($db, $id_societe, $val*$base_pourcentage*$base_pourcentage, 2)),0,0,'R');
              ...
              $ind = indemnite_flottante($db, $obj_salarie->rowid);
                  ...
                  $pdf->SetLeftMargin(83);
                  $pdf->Cell(20,4, utf8_decode(apres_virgule($db, $id_societe, $val*$base_pourcentage, 2)),0,0,'R');
              ...
              $pdf->SetLeftMargin(103);
              $pdf->Cell(30,4, utf8_decode(apres_virgule($db, $id_societe, $sursalaire, 2)),0,0,'R');
      ...
      $pdf->MultiCell(31,4, utf8_decode(apres_virgule($db, $id_societe, round($salaire_net+$retenu), 2)),0,'R','true');
      ...
      $pdf->Cell(28,4, utf8_decode("Avance :"),0,0,'L','true');

      $pdf->SetLeftMargin(161);
      $pdf->MultiCell(31,4, utf8_decode(apres_virgule($db, $id_societe, $somme_avance, 2)),0,'R','true');
      ...
      $pdf->SetLeftMargin(161);
      $pdf->MultiCell(31,4, utf8_decode(apres_virgule($db, $id_societe, round($salaire_net-$somme_avance), 2)),0,'R','true');
  ...
  if($onglet_salarie == ''){
    ...
    //les informations à droite du petit rectangle en haut du rectangle moyen
      ...
      $pdf->SetY($y);
      $pdf->SetX($x);
      $pdf->MultiCell($pdf->GetPageWidth()-12-82 - 5,5,utf8_decode($date." ".$societe_Salarie->nom),0,'C');
      ...
      $pdf->SetY($y);
      $pdf->SetX($x);
      $pdf->MultiCell($pdf->GetPageWidth()-12-82 - 5,3,utf8_decode("Moyen de paiement par : ".$obj_salarie->banque ),0,'C');
  
      $y += 4;
      $pdf->SetY($y);
      $pdf->SetX($x);
      $pdf->MultiCell($pdf->GetPageWidth()-12-82 - 5,3,utf8_decode("Compte : ".$obj_salarie->compte ),0,'C');
      ...
      $pdf->Cell(30 - 5,3,utf8_decode("Sexe. "),0,0,'L');
      $sexe = "N/A";
      if($obj_user->gender == "man")
      $sexe = "Masculin";
      else if($obj_user->gender == "woman")
        $sexe = "Féminin";
      $pdf->SetTextColor(0, 0, 70);
      $pdf->SetFont('Helvetica','',8);
      $pdf->SetX($xgauche);
      ...
      $y_moyen_left = $y_moyen_left + 5;
         ...
         $pdf->SetX(14);
      $pdf->Cell(30 - 5,3,utf8_decode("St.Fam. "),0,0,'L');
      $situation_familiale = $obj_salarie->situation_familiale;
      $pdf->SetTextColor(0, 0, 70);
      $pdf->SetFont('Helvetica','',8);
      $pdf->SetX($xgauche);
      $pdf->Cell(40,3,utf8_decode($situation_familiale),0,1,'L');
      ...
      $y_moyen_left = $y_moyen_left + 5;
         ...
         $pdf->SetX(14);
      $pdf->Cell(30 - 5,3,utf8_decode("Nb enf/hand. "),0,0,'L');
      $nb_enf = $obj_salarie->nombre_enfant."/".$obj_salarie->nombre_enfant_hand;
      $pdf->SetTextColor(0, 0, 70);
      $pdf->SetFont('Helvetica','',8);
      $pdf->SetX($xgauche);
      $pdf->Cell(40,3,utf8_decode($nb_enf),0,1,'L');
      ...
      $y_moyen += 4;
         ...
         $pdf->SetX(82 + 8 + 2);
      $pdf->Cell(35 - 5,3,utf8_decode("Nom Prénom "),0,0,'L');
      $nom_prenom = $obj_user->lastname." ".$obj_user->firstname;
      $pdf->SetTextColor(0, 0, 70);
      $pdf->SetFont('Helvetica','',8);
      $pdf->SetX($xDebut);
      $pdf->Cell($long ,3,utf8_decode($nom_prenom),0,1,'L');
      ...
      $pdf->SetFont('Helvetica','',8);
      $pdf->SetX($xDebut);
      $pdf->Cell($long ,3,utf8_decode($obj_salarie->matricule),0,1,'L');
