...
if($action == "detailprime"){
	...
	print '<tr class="liste_titre"><td align="center" class="liste_titre" colspan="4" style="padding: 10px; width : 5%;" >Accord etablissement</td></tr>';
		...
		if($result1){
			...
			if($num == 0)
				print "<tr><td align='center' colspan='4'>Aucun Accord etablissement trouvé</td></tr>";
		}else print "<tr><td align='center' colspan='4'>Aucun Accord etablissement trouvé</td></tr>";
