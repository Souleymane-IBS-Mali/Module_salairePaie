...
CREATE TABLE llx_condition_prime
(
  rowid                 integer             AUTO_INCREMENT PRIMARY KEY,
  fk_prime              integer             NOT NULL,
  fk_type_salarie       integer             NOT NULL DEFAULT 0,
  fk_categorie          integer             NOT NULL DEFAULT 0,
  type_montant          varchar(255)        NOT NULL DEFAULT 0, --forfait, pourcentage et flottante
