...
/**
 * \file    test/phpunit/PaiementSalaireFunctionalTest.php
...
/**
 * Class PaiementSalaireFunctionalTest
 *
 ...
 *
 * @package Testpaiementsalaire
 */
class PaiementSalaireFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPaiementSalaire')->click();
		} else {
			// Disable the module
			$this->byHref('modPaiementSalaire')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/paiementsalaire/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('paiementsalaire/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/paiementsalaire/admin/about.php');
		$this->authenticate();
		return $this->assertContains('paiementsalaire/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('paiementsalairewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPaiementSalaire_PaiementSalaireTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPaiementSalaire_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
