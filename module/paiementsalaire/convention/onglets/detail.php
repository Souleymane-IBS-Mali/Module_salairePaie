...
$titre = "Detail de la catégorie <b><mark>".$obj->code_categorie."</mark></b> de la convention ".$nom_convention;
...
if($action == 'create'){
	$titre = "Ajout d'échélon à la catégorie <b><mark>".$obj->code_categorie."</mark></b> de la convention ".$nom_convention;
print load_fiche_titre($langs->trans($titre), '', '');
$head = paiementsalaireConventionHead($id_convention);
print dol_get_fiche_head($head, 'categorie', "", -1, '');			
	//Titre 
...
print '<input type="hidden" name="action" value="add">';
 ...
 print '<td style=" padding-right: 30px"><input type="text" name="libelle" value="'.(GETPOST("libelle")?:"").'"></td></tr>';

 print '<tr><td class="fieldrequired" style=" padding-right: 30px"><label>Description</label></td>';
 print '<td style=" padding-right: 30px"><textarea type="text" name="desc" value="'.(GETPOST("desc")?:"").'"></textarea></td></tr>';

 print '<tr><td class="fieldrequired" style=" padding-right: 30px"><label>Salaire de Base</label></td>';
 print '<td style=" padding-right: 30px"><input type="text" name="salaire_base" value="'.(GETPOST("salaire_base")?:"").'"></td></tr>';
