Dolibarr ERP & CRM est un progiciel moderne qui permet de gérer les activités de votre organisation (contacts, devis, factures, commandes, stocks, agenda, ressources humaines, GCE, fabrication…).

C'est une suite logicielle Open-Source (écrite en PHP avec des améliorations JavaScript) conçue pour les petites, moyennes ou grandes entreprises, les fondations et les indépendants.

Il peur être utiliser, étudier, modifier ou le distribuer librement selon sa licence.
...
permettant ainsi aux équipes RH et comptables de se concentrer sur des tâches à haute valeur ajoutée.

https://docs.google.com/document/d/1CWng3ljDe2ObcgmG3vRcMvEdq_03w7Ie7oj8XRdB9C0/edit?usp=sharing
