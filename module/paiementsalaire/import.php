...
//Titre 
print load_fiche_titre($langs->trans("Import des données"), '', '');
print '<hr>';
...
print '<div class="div-table-responsive-no-min">';
                ...
                print '<th>Imports</th><th></th><th></th>';
                print '</tr>';

                print '<tr class="oddeven nodrag nodrop nohover">';
                print '<td><a href="#" >Import salaires</a></td>';
                print '<td></td>';
                print '<td></td>';
        ...
        print '</table>';//header('Location: ./compta/facture/card.php');
